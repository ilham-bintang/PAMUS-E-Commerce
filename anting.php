...
<h1 align="center">KATEGORI: ANTING</h1>
<br>
<table class="w3-table w3-striped w3-border" align="center">
	...
	<?php
        ...
        session_start(); 
  		...
  		$hasil=mysqli_query($konek, "SELECT substring(desk,1, 20) as deskripsi , kd_barang,nama_brg,harga, gambar_barang from barang where jenis='anting' order by kd_barang desc");
